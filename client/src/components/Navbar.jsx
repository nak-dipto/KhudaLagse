...
export default function Navbar() {
	...
	return (
		<header className="w-full">
			...
			{!user && (
				<div className="sticky top-0 z-50 w-full bg-gradient-to-r from-blue-400 via-blue-500 to-blue-500 text-white text-sm flex justify-end gap-4 px-4 py-2 shadow-md">
					<button
			...
			{/* Main Navbar */}
			<nav className="sticky top-0 z-50 w-full flex justify-between items-center px-4 sm:px-8 py-3 bg-white shadow-md">
				{/* Logo */}
				<Link
					to="/"
