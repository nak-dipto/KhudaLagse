    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            onClick={goToToday}
            className="ml-2 px-4 py-2 bg-violet-500 text-white rounded-lg text-sm font-semibold hover:bg-violet-600 transition"
          >
            Today
          </button>
        </div>
      ...
      {Object.keys(mealsByDate).length === 0 && (
        <div className="bg-gradient-to-br from-white to-violet-50 rounded-2xl shadow-md p-6 text-center border border-violet-100">
          ...
          <button
            ...
            className="px-4 py-2 bg-violet-500 text-white rounded-lg font-semibold hover:bg-violet-600 transition text-sm"
          >
            Browse Restaurants
          </button>
        </div>
